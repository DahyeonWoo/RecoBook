...
class Aladin:
    ...
    def post_book():
        ...
        category_id = 40173
        """ 
        656인문학, 798사회과학, 50935로맨스, 50930과학소설(SF), 50931호러.공포소설, 50932무협소설
        ...
        for starting_page in range(1,10):
            ...
            url = f"http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey={str(ttbkey)}&QueryType=Bestseller&MaxResults=50&start={starting_page}&SearchTarget=Book&output=js&Version=20131101&CategoryId={category_id}" # 8번행 건너뜀 # 18번 error #21번 건너뜀 # 시나공 책 하나 제외 21번 중복 # 22번 중복
            db_cursor = db.cursor()
